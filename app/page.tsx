...
const climbs = [
  ...
  { id: "north-twin-north-face", name: "North Twin, WA — North Face", region: "Washington Cascades", lat: 48.762, lon: -121.689, summitM: 2026, style: "winter alpine / north face", routeType: "mixed_alpine_ice", defaultMode: "winter", activeFromMonth: 1, thresholds: { maxSummitWindKph: 35, maxPrecipMm24h: 2, maxPrecipMm3Day: 4, minFreezingLevelM: 900, maxFreezingLevelM: 2300, idealFreezingLevelM: 1700, minSummitTempC: -16, maxSummitTempC: 1, windPenaltyPerKph: 0.10, precipPenaltyPerMm: 0.6, requiresOvernightFreeze: true, requiresClearSkies: true } },
  { id: "shuksan-north-face", name: "Mount Shuksan — North Face", region: "Washington Cascades", lat: 48.832, lon: -121.602, summitM: 2783, style: "winter alpine / glaciated north face", routeType: "mixed_alpine_ice", defaultMode: "winter", activeFromMonth: 1, thresholds: { maxSummitWindKph: 35, maxPrecipMm24h: 2, maxPrecipMm3Day: 4, minFreezingLevelM: 1000, maxFreezingLevelM: 2800, idealFreezingLevelM: 2200, minSummitTempC: -18, maxSummitTempC: 1, windPenaltyPerKph: 0.10, precipPenaltyPerMm: 0.6, requiresOvernightFreeze: true, requiresClearSkies: true } },
  { id: "rainier-fuhrer-finger", name: "Mount Rainier — Fuhrer Finger", region: "Washington Cascades", lat: 46.852, lon: -121.76, summitM: 4392, style: "spring alpine / ski mountaineering", routeType: "mixed_alpine_ice", defaultMode: "winter", activeFromMonth: 1, thresholds: { maxSummitWindKph: 35, maxPrecipMm24h: 1, maxPrecipMm3Day: 2.5, minFreezingLevelM: 2500, maxFreezingLevelM: 4300, idealFreezingLevelM: 3700, minSummitTempC: -18, maxSummitTempC: 1, windPenaltyPerKph: 0.11, precipPenaltyPerMm: 0.65, requiresOvernightFreeze: true, requiresClearSkies: true } },
];
...
function runTests() {
  ...
  console.assert(climbs.find((c) => c.id === "shuksan-north-face")?.routeType === "mixed_alpine_ice", "Shuksan North Face should be mixed alpine/ice");
}

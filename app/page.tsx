...
export default function MountainWindowApp() {
  ...
  }, [hasLiveData, climb.id, bestWindow, windowQuality, mode, avalanche.riskScore]);
  ...
  return <div className="min-h-screen bg-slate-50 p-4 md:p-8"><div className="mx-auto max-w-7xl space-y-6">
    ...
    {tab === "logic" && <Card><CardContent className="space-y-5 p-5"><h3 className="font-semibold">How this version scores route types</h3><p className="text-slate-600"><strong>Corn-cycle ski objectives</strong> reward overnight freeze, high pressure, light wind, low precip, and daytime warming/freezing level rising close to the summit. Summit highs near or slightly above 0°C can improve corn timing; the model penalizes no refreeze, excessive heat, wind, or new precip.</p><p className="text-slate-600"><strong>Pure rock objectives</strong> heavily reward dry, clear, warm weather with freezing levels above the summit and penalize any precip or below-freezing summit temperatures.</p><p className="text-slate-600"><strong>Mixed alpine / ice objectives</strong> reward clear weather, low precip, manageable wind, and a useful freeze/refreeze while penalizing both extreme cold and sloppy warm conditions.</p><p className="text-slate-600">Backend failures are displayed as NO DATA. Short-range model gaps are displayed as gaps/unavailable, not zero wind, zero temperature, or zero pressure.</p></CardContent></Card>}
  </div></div>;
}
